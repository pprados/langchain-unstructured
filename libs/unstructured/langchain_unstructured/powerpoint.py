...
from langchain_unstructured.parsers.powerpoint import UnstructuredPowerPointParser
from langchain_unstructured.unstructured import _UnstructuredBaseLoader


class UnstructuredPowerPointLoader(_UnstructuredBaseLoader):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community import UnstructuredPowerPointLoader
