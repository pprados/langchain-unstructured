...
from langchain_unstructured.parsers.org_mode import UnstructuredOrgModeParser
from langchain_unstructured.unstructured import _UnstructuredBaseLoader


class UnstructuredOrgModeLoader(_UnstructuredBaseLoader):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community import UnstructuredOrgModeLoader
    ...
    def lazy_load(
        ...
        blob = Blob(path=self.file_path, mimetype=FileType.ORG.mime_type)
