...
from langchain_unstructured.parsers.xml import UnstructuredXMLParser
from langchain_unstructured.unstructured import _UnstructuredBaseLoader


class UnstructuredXMLLoader(_UnstructuredBaseLoader):
    ...
    Instantiate:
        ...
        .. code-block:: python
            ...
            blob=Blob.from_path("example.xml")
