...
from langchain_unstructured.parsers.base import (
    ...
    DEFAULT_MODE,
    Type_extract_tables,
    Type_file_path, Type_simple_mode,
)
from langchain_unstructured.parsers.epub import UnstructuredEPubParser
from langchain_unstructured.unstructured import _UnstructuredBaseLoader


class UnstructuredEPubLoader(_UnstructuredBaseLoader):
