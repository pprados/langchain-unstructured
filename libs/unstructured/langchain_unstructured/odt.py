...
from langchain_unstructured.parsers.odt import UnstructuredODTParser
from langchain_unstructured.unstructured import _UnstructuredBaseLoader


class UnstructuredODTLoader(_UnstructuredBaseLoader):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community import UnstructuredODTLoader
