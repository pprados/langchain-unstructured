...
@pytest.mark.local
def test_unstructured_html_parser(kwargs: Any, len_docs: int, blob: Blob) -> None:
    """Test unstructured loader."""
    parser = UnstructuredHTMLParser(**kwargs)
...
def test_unstructured_html_parser_via_api(blob: Blob) -> None:
    """Test unstructured loader."""
    parser = UnstructuredHTMLParser(mode="single", partition_via_api=True)
    docs = list(parser.lazy_parse(blob))
